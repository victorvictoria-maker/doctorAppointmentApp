            ...
            <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
              <div className='lg:w-[570px]'>
                <h1 className='text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]'>
                  We patients live a healthy, longer life.
                </h1>
                <p className='text_para'>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Dolores veniam omnis exercitationem architecto eligendi velit
                  deleniti illo neque cumque at cupiditate quia inventore non
                  esse quaerat earum, sed dolorum maxime.
                </p>
              ...
              <div className='flex gap-[30px] justify-end'>
                <div>
                  <img className='w-full' src={heroImage01} alt='Hero Image' />
                </div>
                <div className='mt-[30px]'>
                  <img
                    ...
                    alt='Hero Image'
                  />
                  <img className='w-full' src={heroImage03} alt='Hero Image' />
                </div>
              </div>
            </div>
          </div>
              ...
              <div className='px-5 py-[30px]'>
                ...
                <div className='mt-[30px]'>
                  ...
                  <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>
                    World-class care for everyone. Our health unmatched, expert
        ...
        <section>
          <div className='container'>
            <div className='mx-auto xl:w-[470px]'>
              ...
              <p className='text_para text-center'>
                World-class care for everyone. Our health Ssytem offers
                unmatched, expert health care.
              </p>
            </div>
            ...
            <div className='flex items-center justify-between flex-col lg:flex-row'>
              <div className='xl:w-[670px]'>
                ...
                <ul className='pl-4'>
                  ...
                  <li className='text_para'>
                    3. Visit our physicians who are accepting new patients, use
              ...
              <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
                <img src={featureImage} alt='Feature Image' className='w-3/4' />
                ...
                <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] md:bottom-[100px] left-0  md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='w-5 h-5 lg:w-[34px] lg:h-[34px] flex items-center justify-center bg-yellowColor rounded py-1 px-[6px] lg:py-3 lg:px-[9px]'>
                      <img src={videoIcon} alt='Video Image' />
                    </span>
                  </div>

                  <div className='w-[65px] lg:w-[96px] bg-[#CCFDF3] py-1 px-2 lg:py-[6px] lg:px-[10px] text-[8px] leading-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor font-[500] mt-2 lg:mt-4 rounded-4'>
                    Consultation
                  </div>
